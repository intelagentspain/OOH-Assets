...
const bayzProject: ProjectCommandProject = {
  ...
  targetHandover: '2026-06-30',
  status: 'monitor',
  completion: 28,
  budgetUsed: 41,
  daysToHandover: 420,
  mainContractor: 'China State Construction Engineering',
  plannedValue: 146_000_000,
  actualCost: 162_000_000,
  earnedValue: 132_000_000,
  cpi: 0.81,
  spi: 0.9,
  costVariance: -30_000_000,
  scheduleVariance: -14_000_000,
  floatRemaining: 12,
  healthScore: 58,
...
const bayzAiContent: ProjectCommandAIContent = {
  ...
  healthScore: {
    ...
    score: 58,
    status: 'monitor',
    topThreat: 'Tower crane logistics and facade procurement are compressing the critical path. If the lifting plan is not resequenced this month, the superstructure handoff slips into late Q3.',
    recommendedAction: 'Approve the revised crane utilization plan, lock facade package release dates, and add a night-shift pour sequence for Levels 18-24.',
    scoreBreakdown: { programme: 54, cost: 49, quality: 66, risk: 57, contractor: 64 },
    forecast30d: { completion: 35, spend: 184, newRisks: 5, sparkline: [28, 29.1, 30.4, 31.6, 32.4, 33.1, 33.8, 34.2, 34.7, 35] },
  },
  topDecisions: [
