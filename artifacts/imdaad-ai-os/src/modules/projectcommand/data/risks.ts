...
export const risks: Risk[] = [
  ...
  { id: 'r03', title: 'MEP coordination - 14 unresolved clashes L10-L12', category: 'quality', probability: 4, impact: 3, score: 12, severity: 'high', status: 'open', owner: 'Design Team', mitigation: 'Emergency coordination meeting scheduled 30 Jul. Sobha MEP Services to issue resolved model by 3 Aug.' },
  ...
  { id: 'r05', title: 'Sobha Waterproofing performance decline', category: 'quality', probability: 4, impact: 3, score: 12, severity: 'high', status: 'open', owner: 'Site Manager', mitigation: 'Issue performance notice. Identify backup crew.' },
  ...
  { id: 'r07', title: 'Facade procurement lead time', category: 'programme', probability: 3, impact: 3, score: 9, severity: 'medium', status: 'open', owner: 'Procurement', mitigation: 'Sobha Facade Systems to confirm order within 2 weeks.' },
  { id: 'r08', title: 'Piling vibration - neighbouring property complaint', category: 'external', probability: 2, impact: 3, score: 6, severity: 'medium', status: 'mitigating', owner: 'HSE Manager', mitigation: 'Monitoring sensors installed. Limit works to 08:00-18:00.' },
  ...
  { id: 'r11', title: 'Crane capacity - peak concurrent lifts', category: 'safety', probability: 2, impact: 2, score: 4, severity: 'low', status: 'open', owner: 'HSE Manager', mitigation: 'Lift scheduling matrix to be submitted by Sobha Construction.' },
