...
export const mockIncidents = [
  ...
  },
  {
    ...
    severity: 'critical', slaMinutes: 120, elapsed: 14, lat: 25.1160, lng: 55.3785, source: 'AI Capture',
  ...
  },
  {
    ...
    severity: 'critical', slaMinutes: 240, elapsed: 31, lat: 25.1170, lng: 55.3750, source: 'Resident App',
  ...
  },
  {
    ...
    severity: 'critical', slaMinutes: 180, elapsed: 45, lat: 25.1175, lng: 55.3775, source: 'Resident App',
  ...
  },
  {
    ...
    severity: 'critical', slaMinutes: 360, elapsed: 12, lat: 25.1168, lng: 55.3762, source: 'Resident App',
    status: 'open', assignedTech: null, techId: null, closureNotes: null,
...
export const mockPortfolioClients: PortfolioClient[] = [
  ...
  },
  {
    ...
    dataSources: [
      { label: 'BMS', count: 210 },
      { label: 'Access Control', count: 54 },
      { label: 'Resident App', count: 34 },
    ],
  ...
  },
  {
    ...
    overdueTasks: 7,
    dataSources: [
      { label: 'ProjectCommand Twin', count: 1 },
      { label: 'Evidence Command', count: 42 },
      { label: 'VendorIQ', count: 6 },
      { label: 'ResidentPortal', count: 680 },
    ],
    aiInsight: 'Sobha pilot view is tracking quality, delivery, evidence, approvals, vendor performance, and handover confidence through one live control twin.',
    lastUpdated: 'just now',
    topSites: [
      { name: 'Sobha Pilot Tower', status: 'warning', incidents: 2 },
      { name: 'Sobha Evidence Command', status: 'ok', incidents: 0 },
      { name: 'Sobha Handover Stream', status: 'warning', incidents: 1 },
    ],
    recentActivity: [
      { time: 'Just now', event: 'ProjectCommand baseline synced to Sobha pilot tower', type: 'ok' },
      { time: '5 min ago', event: 'Evidence readiness check flagged 3 confirmation items', type: 'warning' },
      { time: '12 min ago', event: 'AI manager action queue refreshed from latest project events', type: 'ok' },
    ],
    people: {
      accountManager: { name: 'Dina Moussa', role: 'Account Manager', initials: 'DM', status: 'available' },
      fmManager: { name: 'Yassir Nabil', role: 'FM Manager', initials: 'YN', status: 'available' },
      supervisors: [],
      technicians: [],
    },
    resources: {
      ...
      budgetTotal: 420,
      fleet: [
        { label: 'Site Response Teams', available: 5, total: 6 },
        { label: 'QA Inspectors', available: 8, total: 10 },
      ],
      partsStock: [
        { name: 'Fire-stopping evidence pack', qty: 3, status: 'low' },
        { name: 'Facade release package', qty: 1, status: 'low' },
        { name: 'Authority approval tracker', qty: 6, status: 'ok' },
      ],
      equipment: [
        { name: 'Tower Crane 01', condition: 76, nextService: '9 days' },
        { name: 'Concrete Logistics Plan', condition: 82, nextService: '14 days' },
        { name: 'Inspection Evidence Workflow', condition: 88, nextService: '30 days' },
      ],
    },
    contract: {
      number: '4C360-2026-SOBHA-PILOT',
      tier: 'Platinum',
      startDate: '1 May 2026',
      endDate: '30 Jun 2026',
      renewalDate: '15 Jun 2026',
      annualValue: '6-8 week pilot scope',
      penalties: 'Pilot success metrics: float protected, evidence gaps closed, handover confidence improved',
      responseTimes: [
        { severity: 'Critical', target: '< 60 min' },
        { severity: 'High', target: '< 3 hrs' },
        { severity: 'Medium', target: '< 6 hrs' },
      ...
      vendorManager: 'DevelopmentX Project Controls',
      notes: 'Sobha-specific seed for the live project control twin pitch. Public claims remain evidence-led; operational pain points are pilot hypotheses.',
    },
    lat: 25.1760,
    lng: 55.2880,
    marketLabel: 'Sobha Pilot',
  },
  {
    id: 'CLT-008',
    name: 'Damac',
    ...
    lastUpdated: 'just now',
    topSites: [
      { name: 'Site A', status: 'ok', incidents: 0 },
    ],
    recentActivity: [
      { time: 'Just now', event: 'Live status confirmed', type: 'ok' },
    ],
    people: {
      accountManager: { name: 'Dina Moussa', role: 'Account Manager', initials: 'DM', status: 'available' },
      fmManager: { name: 'Yassir Nabil', role: 'FM Manager', initials: 'YN', status: 'available' },
    ...
    contract: {
      number: 'IMD-2026-DMC-008',
      tier: 'Standard',
      startDate: '1 May 2026',
      endDate: '30 Apr 2027',
      renewalDate: '1 Feb 2027',
      annualValue: 'AED 120K',
      penalties: 'Standard SLA penalties apply',
      responseTimes: [
        { severity: 'Critical', target: '< 60 min' },
        { severity: 'High', target: '< 3 hrs' },
        { severity: 'Medium', target: '< 6 hrs' },
      ...
      vendorManager: 'DevelopmentX HQ',
      notes: 'Newly onboarded property. Baseline operations data is being collected.',
    },
    lat: 25.0600,
    lng: 55.2050,
    marketLabel: 'Site A',
